...
$stmt=$mysqli->prepare("SELECT email,password,id,firstName FROM userregistration WHERE email='".$email."' and password='".$password."' ");
				$stmt->bind_param('ss',$email,$password);
				$stmt->execute();
				$stmt -> bind_result($email,$password,$id,$name);
				$rs=$stmt->fetch();
				$stmt->close();
				$_SESSION['id']=$id;
